...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-primary/90 to-primary py-16 sm:py-24 md:py-32 text-primary-foreground overflow-hidden min-h-[80vh] flex items-center">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-3 sm:mb-4 text-primary-foreground/90 animate-slideUp animate-delay-300">
              Cansado de perder vendas e oportunidades?
            </h2>
            <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-primary-foreground/80 animate-slideUp animate-delay-600 max-w-2xl mx-auto md:mx-0">
            ...
            <Button
              ...
              className="w-full sm:w-auto bg-white text-primary hover:bg-white/90 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 h-auto font-semibold animate-slideUp animate-delay-600
